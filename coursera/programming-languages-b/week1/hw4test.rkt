...
(define l (make-list 2000000 (cons 5 5)))
(set! l (list-set l (- 2000000 1) (cons 9 9)))
(define caches (cached-assoc l 3))
...
(define tests
  (test-suite
   ...
   (check-equal? (list-nth-mod (list 0 1 2 3 4) 0) 0)
   ...
   (check-equal? (stream-for-n-steps (cycle-lists (list 1 2 3) (list "a" "b")) 3) (list (cons 1 "a") (cons 2 "b") (cons 3 "a")) 
                 "cycle-lists test")
   ; Lookup skips non-pairs (car: contract violation   expected: pair?   given: 5) [error]
   ; vector-assoc test
   (check-equal? (vector-assoc 4 (vector (cons 2 1) (cons 3 1) (cons 4 1) (cons 5 1))) (cons 4 1) "vector-assoc test")
   (check-equal? (vector-assoc 4 (vector 1 2 3 (cons 2 1) (cons 3 1) (cons 4 1) (cons 5 1))) (cons 4 1))
   ; cached-assoc tests
   (check-equal? ((cached-assoc (list (cons 1 2) (cons 3 4)) 3) 3) (cons 3 4) "cached-assoc test")
   (check-equal? (caches 9) (cons 9 9))
